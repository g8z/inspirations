...
<table summary="" style="width:100%; height:100%" border="0" cellspacing="10">
  ...
  <tr>
    ...
    <table summary="" style="width:100%; height:100%">
        ...
        <tr style="height:30px">
          <td class="cell_header" nowrap>Table Prefix of Previous Installation</td>
          <td class="cell_header" >
            <input type="text" name="db_ppfx" value="<?php echo (isset($_SESSION['INST']['DB_PPFX'])?$_SESSION['INST']['DB_PPFX']:((isset($_POST['db_ppfx']))?$_POST['db_ppfx']:''))?>" />
          </td>
        </tr>
        <tr>
