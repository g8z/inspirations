...
$gCredits = array();
$gCredits['HTML_Title'] = 'Inspirations';
$gCredits['HTML_Description'] = 'Inspirations Description';
...
/* Auto print on print link when page is loaded */
$autoPrint = false;
...
define('HOME', 'http://localhost/inspirations'.'/');
