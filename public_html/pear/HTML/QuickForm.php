...
$GLOBALS['HTML_QUICKFORM_ELEMENT_TYPES'] = 
        array(
            'group'         =>array(PEAR_DIR.'/HTML/QuickForm/group.php','HTML_QuickForm_group'),
            'hidden'        =>array(PEAR_DIR.'/HTML/QuickForm/hidden.php','HTML_QuickForm_hidden'),
            'reset'         =>array(PEAR_DIR.'/HTML/QuickForm/reset.php','HTML_QuickForm_reset'),
            'checkbox'      =>array(PEAR_DIR.'/HTML/QuickForm/checkbox.php','HTML_QuickForm_checkbox'),
            'file'          =>array(PEAR_DIR.'/HTML/QuickForm/file.php','HTML_QuickForm_file'),
            'image'         =>array(PEAR_DIR.'/HTML/QuickForm/image.php','HTML_QuickForm_image'),
            'password'      =>array(PEAR_DIR.'/HTML/QuickForm/password.php','HTML_QuickForm_password'),
            'radio'         =>array(PEAR_DIR.'/HTML/QuickForm/radio.php','HTML_QuickForm_radio'),
            'button'        =>array(PEAR_DIR.'/HTML/QuickForm/button.php','HTML_QuickForm_button'),
            'submit'        =>array(PEAR_DIR.'/HTML/QuickForm/submit.php','HTML_QuickForm_submit'),
            'select'        =>array(PEAR_DIR.'/HTML/QuickForm/select.php','HTML_QuickForm_select'),
            'hiddenselect'  =>array(PEAR_DIR.'/HTML/QuickForm/hiddenselect.php','HTML_QuickForm_hiddenselect'),
            'text'          =>array(PEAR_DIR.'/HTML/QuickForm/text.php','HTML_QuickForm_text'),
            'textarea'      =>array(PEAR_DIR.'/HTML/QuickForm/textarea.php','HTML_QuickForm_textarea'),
            'link'          =>array(PEAR_DIR.'/HTML/QuickForm/link.php','HTML_QuickForm_link'),
            'advcheckbox'   =>array(PEAR_DIR.'/HTML/QuickForm/advcheckbox.php','HTML_QuickForm_advcheckbox'),
            'date'          =>array(PEAR_DIR.'/HTML/QuickForm/date.php','HTML_QuickForm_date'),
            'static'        =>array(PEAR_DIR.'/HTML/QuickForm/static.php','HTML_QuickForm_static'),
            'header'        =>array(PEAR_DIR.'/HTML/QuickForm/header.php', 'HTML_QuickForm_header'),
            'html'          =>array(PEAR_DIR.'/HTML/QuickForm/html.php', 'HTML_QuickForm_html'),
            'hierselect'    =>array(PEAR_DIR.'/HTML/QuickForm/hierselect.php', 'HTML_QuickForm_hierselect'),
            'autocomplete'  =>array(PEAR_DIR.'/HTML/QuickForm/autocomplete.php', 'HTML_QuickForm_autocomplete'),
            'xbutton'       =>array(PEAR_DIR.'/HTML/QuickForm/xbutton.php','HTML_QuickForm_xbutton')
        );

$GLOBALS['_HTML_QuickForm_registered_rules'] = array(
    'required'      => array('html_quickform_rule_required', PEAR_DIR.'/HTML/QuickForm/Rule/Required.php'),
    'maxlength'     => array('html_quickform_rule_range',    PEAR_DIR.'/HTML/QuickForm/Rule/Range.php'),
    'minlength'     => array('html_quickform_rule_range',    PEAR_DIR.'/HTML/QuickForm/Rule/Range.php'),
    'rangelength'   => array('html_quickform_rule_range',    PEAR_DIR.'/HTML/QuickForm/Rule/Range.php'),
    'email'         => array('html_quickform_rule_email',    PEAR_DIR.'/HTML/QuickForm/Rule/Email.php'),
    'regex'         => array('html_quickform_rule_regex',    PEAR_DIR.'/HTML/QuickForm/Rule/Regex.php'),
    'lettersonly'   => array('html_quickform_rule_regex',    PEAR_DIR.'/HTML/QuickForm/Rule/Regex.php'),
    'alphanumeric'  => array('html_quickform_rule_regex',    PEAR_DIR.'/HTML/QuickForm/Rule/Regex.php'),
    'numeric'       => array('html_quickform_rule_regex',    PEAR_DIR.'/HTML/QuickForm/Rule/Regex.php'),
    'nopunctuation' => array('html_quickform_rule_regex',    PEAR_DIR.'/HTML/QuickForm/Rule/Regex.php'),
    'nonzero'       => array('html_quickform_rule_regex',    PEAR_DIR.'/HTML/QuickForm/Rule/Regex.php'),
    'callback'      => array('html_quickform_rule_callback', PEAR_DIR.'/HTML/QuickForm/Rule/Callback.php'),
    'compare'       => array('html_quickform_rule_compare',  PEAR_DIR.'/HTML/QuickForm/Rule/Compare.php')
);
...
class HTML_QuickForm extends HTML_Common {
     ...
     * @access    public
     */
    var $_requiredNote = '<span style="color:#ff0000;">*</span><span style=""> denotes required field</span>';
