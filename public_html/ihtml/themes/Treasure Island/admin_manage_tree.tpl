...
{/if}  <tr>
    ...
    <table summary="" width="100%" border="0" cellpadding="5" cellspacing="2" class="white">
     ...
     <tr class="normal">
      ...
      <tr class="normal" valign="top">
        <td class="normal" colspan=2>{$lang.to_add_node}<br /></td>
      </tr>
      <tr class="normal" valign="top">
        <td class="normal" colspan=2>{$lang.to_edit_node}<br /></td>
      </tr>
      <tr class="normal" valign="top">
        <td class="normal" colspan=2>{$lang.to_delete_node}<br /></td>
      </tr>
      <tr class="normal" valign="top">
        <td class="normal" colspan=2>{$lang.to_move_node}<br /></td>
      </tr>
      <tr class="normal" valign="top">
        <td class="normal" colspan=2>{$lang.to_approve_node}<br /></td>
      </tr>
      </table>
    </td>
  </tr>
